...
# 1) Read data --------
data <- read.csv("Input_Data/Sample_Metadata.csv")
...
# 3) picture paths -----------
mef_figure_path <- "Input_Data/Pictures/MEF_marked.png"

site_photos <- tibble(
  Site  = c("T1", "BLF", "US2", "S3", "LC"),
  Title = c("S1-bog", "BLF-poor fen", "US2-fen", "S3-fen", "LC-shrub wetland"),
  image = c(
    "Input_Data/Pictures/T1_cropped.jpg",
    "Input_Data/Pictures/BLF_Cropped.png",
    "Input_Data/Pictures/US2_Cropped.jpg",
    "Input_Data/Pictures/S3_Cropped.jpg",
    "Input_Data/Pictures/LC_cropped.jpg"
  )
)
