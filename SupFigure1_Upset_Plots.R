...
# =========================================================
# 2) HELPER: save an UpSet plot directly as SVG
# =========================================================
...
# =========================================================
# 3) HELPER: save a 5-set Venn diagram directly as SVG
# =========================================================
...
# =========================================================
# 5) SAVE ALL FOUR PANELS AS SEPARATE SVGs
# =========================================================

dir.create("Plots/New/SVG", showWarnings = FALSE, recursive = TRUE)

save_upset_svg(HILIC_compounds, "HILIC", "Plots/New/SVG/SupFig1a_upset_HILIC.svg")
save_venn_svg(HILIC_compounds,  "HILIC", "Plots/New/SVG/SupFig1a_venn_HILIC.svg")

save_upset_svg(RP_compounds, "RP", "Plots/New/SVG/SupFig1b_upset_RP.svg")
save_venn_svg(RP_compounds,  "RP", "Plots/New/SVG/SupFig1b_venn_RP.svg")
